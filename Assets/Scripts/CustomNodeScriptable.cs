...
{
    public string idx;
    public Dictionary<string, List<string>> neighbors = new Dictionary<string, List<string>>();
    [HideInInspector] public List<string> neigh_up = new List<string>();
    [HideInInspector] public List<string> neigh_down = new List<string>();
    [HideInInspector] public List<string> neigh_left = new List<string>();
    [HideInInspector] public List<string> neigh_right = new List<string>();
    [HideInInspector] public List<string> neigh_back = new List<string>();
    [HideInInspector] public List<string> neigh_forth = new List<string>();
    ...
    {
        neigh_up = neighbors["up"];
        neigh_down = neighbors["down"];
        neigh_left = neighbors["left"];
        neigh_right = neighbors["right"];
        neigh_back = neighbors["backward"];
        neigh_forth = neighbors["forward"];
    }

    public void LoadNeighbors()
    {
        neighbors["up"] = neigh_up;
        neighbors["down"] = neigh_down;
        neighbors["left"] = neigh_left;
        neighbors["right"] = neigh_right;
        neighbors["backward"] = neigh_back;
        neighbors["forward"] = neigh_forth;
    }
